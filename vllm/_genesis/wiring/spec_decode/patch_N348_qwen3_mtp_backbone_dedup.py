...
def apply() -> tuple[str, str]:
    ...
    # port 2026-07-04: el TextPatcher del framework viejo no expone
    # applied_sub_patches; APPLIED implica las 3 subs requeridas commiteadas
    return "applied", (
        f"PN348 applied: 3/3 sub-patches on qwen3_5_mtp.py — MTP "
