...
ANCHOR_NEW = (
    ...
    "            return\n"
    "        try:\n"
    "            self._genesis_pn81_step = getattr(self, '_genesis_pn81_step', 0) + 1\n"
    "            _every = max(int(_g81_os.environ.get(\n"
    "                'GENESIS_KV_DISK_CHECK_EVERY', '2000')), 1)\n"
    "            if self._genesis_pn81_step % _every:\n"
    "                return\n"
